package cn.mhook.mhook.xposed.pro;
...
public class SettingPro {

    public void init(XC_LoadPackage.LoadPackageParam lpparam) {
        H.p(H.msg("输出日志","自动隐藏Xp特征",""));
                ...
                new XC_MethodHook() {
                    ...
                    protected void beforeHookedMethod(MethodHookParam param) {
                        ...
                        boolean shouldDo = path.matches("/proc/[0-9]+/maps") ||
                                (path.toLowerCase().contains("xposed") &&
                                        !path.startsWith(Environment.getExternalStorageDirectory().getPath()) && !path.contains("fkzhang"));
                        if (shouldDo) {
